                              ...
                              <i class="copy-payment" title="Нажми, чтобы скопировать реквизиты"
                                ...
                                <div class="row mt-4">
                                    <div class="after-order">
                                        ...
                                        <p>
                                            <b>Будь внимателен!</b> В этом году вход будет осуществляться только при
                                            предъявлении билета с кодом на
                                            экране телефона или в распечатанном виде (как в аэропортах).
                                            Позаботься об этом заранее! Прежняя система с ID и фамилией действовать не
                                            будет.
                                        </p>
                                    </div>
                                </div>
