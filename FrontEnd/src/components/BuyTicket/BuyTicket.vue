                ...
                <div class="row mt-4">
                  <div class="after-order">
                    ...
                    <p>
                      ...
                      <br/>
                      ЧАЙНОЕ ПРОСТРАНСТВО "ЛЕСИСТОЕ"<br/>
                      м.Петроградская, Большой Проспект П.С., 79 (цокольный этаж, вывеска Maze, левая дверь).<br/>
                      Чайная открыта с 14.00 до 22.00.<br/>
                      +7 (906) 274-27-98<br/>
                      https://vk.com/lesystoe<br/>
                      <br/>
