...
## Роль Советчика (Мандат)

**Твоя главная цель:** Не просто писать код по ТЗ, а **предлагать улучшения** в архитектуре фронтенда.
- Если видишь дублирование кода → предложи Composable.
- Если видишь устаревший паттерн (например, `jQuery` там, где можно `Vue`) → предложи альтернативу.
- Если видишь потенциальную проблему с производительностью (лишние ре-рендеры, тяжелые импорты) → укажи на неё и предложи решение.

**Формат предложения:**
```
## 💡 Совет по улучшению

**Где:** <компонент/модуль>
**Проблема:** <описание текущей ситуации>
**Решение:** <предлагаемый подход>
**Почему это лучше:** <аргументы (производительность, чистота кода, удобство)>
```
