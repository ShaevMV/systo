...
import { solarPalettes, solarSurfaces } from '@/theme/solar-preset';
import { ref } from 'vue';
...
const primaryColors = ref([
    // Брендовые акценты Solar Systo — первыми в списке.
    { name: 'orange', palette: solarPalettes.orange },
    { name: 'lime', palette: solarPalettes.lime },
    { name: 'wine', palette: solarPalettes.wine },
    { name: 'noir', palette: {} },
...
const surfaces = ref([
    // Брендовые поверхности Solar Systo: plum/navigator (тёмная) и cloud (светлая).
    { name: 'plum', palette: solarSurfaces.plum },
    { name: 'cloud', palette: solarSurfaces.cloud },
    {
        name: 'slate',
