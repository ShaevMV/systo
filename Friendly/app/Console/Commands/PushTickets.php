...
class PushTickets extends Command
{
    ...
    {
        $tickets = FriendlyTicket::where('festival_id','=','9d679bcf-b438-4ddb-ac04-023fa9bff4b8')->get();

        foreach ($tickets as $ticket) {
            $ticketService->pushTicketFriendly($ticket, '9d679bcf-b438-4ddb-ac04-023fa9bff4b8');
