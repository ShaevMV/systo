            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link
                        ...
                        {{ __('Электронные билеты Весна2025') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link
                        href="{{ route('adminTickets',[
                        ...
                        {{ __('Электронные билеты Осень2024') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link
                        href="{{ route('adminTickets',[
                                'festival_id' => '9d679bcf-b438-4ddb-ac04-023fa9bff4b6',
