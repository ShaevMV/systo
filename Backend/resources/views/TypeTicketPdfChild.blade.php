...
<p id="top-class-title">Привет! Это электронный детский билет на Solar Systo Togathering {{date('Y')}}!</p>
...
<p id="sub"><strong style="    color: #86201c;
    ...
    На входе на Систо необходимо показать этот qr-код на экране телефона или в распечатанном виде.
    Ребёнок проходит вместе с сопровождающим взрослым. Позаботься об этом заранее!<br><br>
    До встречи в лесу!</p>
<footer></footer>
</body>
</html>
