            ...
            <table class="data-table" style="border: none; background: white;  box-shadow: 0 0 5px 0 hsla(231,3%,61%,.35);border-radius: 10px; border-collapse: collapse; width: 100%; margin: auto;" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="padding: 20px;">
                        <table style="border: none; border-collapse: collapse;" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="padding-left: 20px; font-size: 30px; font-family: Tahoma, sans-serif;">Оргвзнос на {{$festivalName}}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 10px 20px 20px 20px; border-top: 1px solid #e6e6e6;  border-bottom: 1px solid #e6e6e6;">
                        ...
                        <p style="font-family: Tahoma, sans-serif; font-size: 18px;">Ты можете получить свой конверт с аналоговой картой и стикером в пространстве "Cacao Temple" в Санкт-Петербурге по адресу: м.Сенная Площадь, Садовая ул., 107<br>
                            Кафе открыто с 12.00 до 22.00. <b>Чашка какао в подарок</b></p>
                        <br/>
                        <p style="font-family: Tahoma, sans-serif; font-size: 18px;"><b>ВНИМАНИЕ В ЗАВЕДЕНИИ ПРИНИМАЮТСЯ ТОЛЬКО НАЛИЧНЫЕ!</b> Просьба заранее снять их в банкомате.</p>
                        <p style="font-family: Tahoma, sans-serif; font-size: 18px;">Карту необходимо будет предъявить на входе на Систо! Не забывайте её дома!</p>
