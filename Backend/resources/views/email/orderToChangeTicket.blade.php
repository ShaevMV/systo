            ...
            <table class="data-table" style="border: none; background: white; box-shadow: 0 0 5px 0 hsla(231,3%,61%,.35); border-radius: 10px; border-collapse: collapse; width: 100%; margin: auto;" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="padding: 20px;">
                        <table style="border: none; border-collapse: collapse;" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="padding-left: 20px; font-size: 30px; font-family: Tahoma, sans-serif;">Изменены данные вашего заказа на Solar Systo Togathering {{date('Y')}}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 10px 20px 20px 20px; border-top: 1px solid #e6e6e6; border-bottom: 1px solid #e6e6e6;">
                        <p style="text-align: center; font-family: Tahoma, sans-serif; font-size: 24px; font-weight: 500;">Дорогой друг!</p>
                        <p style="font-family: Tahoma, sans-serif; font-size: 18px;">Мы поменяли данные в вашем заказе:</p>
                        @foreach($changes as $change)
                        <p style="font-family: Tahoma, sans-serif; font-size: 18px;">
                            Ваш билет на имя <strong>{{ $change['oldName'] }}</strong> аннулирован и создан новый билет на имя <strong>{{ $change['newName'] }}</strong>.
                        </p>
                        @endforeach
                        <p style="font-family: Tahoma, sans-serif; font-size: 18px;">Новые билеты прикреплены к этому письму.</p>
                        <p style="font-family: Tahoma, sans-serif; font-size: 18px;">Если у вас возникли вопросы, свяжитесь с организаторами: ticket@spaceofjoy.ru или Telegram — <a href="https://t.me/systo_club" target="_blank">@systo_club</a></p>
