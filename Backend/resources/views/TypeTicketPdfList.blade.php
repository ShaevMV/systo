...
<p id="top-class-title">Привет друг, это твой билет участника на Solar Systo Togathering {{date('Y')}}!</p>
...
<p id="sub"><strong style="    color: #86201c;
    ...
    QR-код участника предоставляется исключительно для личного использования владельцем и не подлежит перепродаже, передаче или использованию третьими лицами.
    В случае выявления факта нарушения билет будет незамедлительно аннулирован без права восстановления, а в посещении Систо будет отказано!
