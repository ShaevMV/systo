...
class OrderTickets extends Controller
{
    ...
    public function create(Request $request, CreateOrderTicketsRequest $createOrderTicketsRequest): JsonResponse
    {
        ...
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Мы успешно зарегистрировали ваш заказ. Скоро мы его проверим, и вы получите свои билеты! <br/>
    ...
    ): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Мы успешно зарегистрировали ваш заказ. Скоро мы его проверим, и вы получите свои билеты!',
            ]);
