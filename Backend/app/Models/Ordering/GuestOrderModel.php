...
/**
 * App\Models\Ordering\GuestOrderModel
 *
 * @property int         $kilter
 * @property string      $id
 ...
 * @method static Builder|GuestOrderModel newModelQuery()
 * @method static Builder|GuestOrderModel newQuery()
 * @method static Builder|GuestOrderModel query()
 * @mixin Eloquent
 */
final class GuestOrderModel extends Model
{
    use HasFactory, HasUuid;

    public const TABLE = 'guest_orders';
