...
class QrOrderGetListQueryHandler implements QueryHandler
{
    ...
    private function getFilterValues(array $filter): array
    {
        return [
            ...
            [
                'field' => QrOrderModel::TABLE.'.external_order_no',
                'operator' => FilterOperator::LIKE,
                'value' => $filter['external_order_no'] ?? null,
            ],
            [
                'field' => QrOrderModel::TABLE.'.payment_method',
                'operator' => FilterOperator::EQUAL,
                'value' => $filter['payment_method'] ?? null,
            ],
            [
                'field' => QrOrderModel::TABLE.'.promo_code',
                'operator' => FilterOperator::EQUAL,
                'value' => $filter['promo_code'] ?? null,
            ],
        ];
    }
}
