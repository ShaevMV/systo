...
namespace Tickets\Shared\Infrastructure\Bus\Event\RabbitMq;

use AMQPException;
use Tickets\Shared\Domain\Bus\Event\DomainEvent;
use Tickets\Shared\Domain\Bus\Event\EventBus;
use Tickets\Shared\Infrastructure\Bus\Event\DomainEventJsonSerializer;
use Tickets\Shared\Infrastructure\Bus\Event\MySql\MySqlDoctrineEventBus;
