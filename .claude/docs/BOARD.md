...
| **Ф2** | Роли смены (`change_user`, 5 ролей) + RBAC-матрица через UI | 🔄 PR-1 #93 ✅ + PR-2 #94 ✅ merged; PR-3 #95 готов к merge; впереди PR-4 (матрица в БД) → PR-5 (permission-middleware) → PR-6 (UI редактора) |
