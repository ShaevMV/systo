 ...
 */
/**
 * Пользователь Baza — это ПЕРСОНАЛ на входе фестиваля (билетёр, охрана, инфоцентр,
 * администратор), а НЕ гость. Гостей в этой системе нет: их билеты только сканируются.
 *
