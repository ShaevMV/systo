...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Fonts (самохостинг: офлайн-вход на КПП, без внешних запросов) -->
        <link href="/black/vendor/poppins/poppins.css" rel="stylesheet" />
        <link href="/black/vendor/fontawesome/css/all.css" rel="stylesheet">
        <!-- Icons -->
