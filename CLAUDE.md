...
> **ПЕРЕД НАПИСАНИЕМ НОВОГО КОДА, ПОСМОТРИ РЕАЛИЗАЦИЮ В СХОЖИХ МЕХАНИЗМОВ, СПРОСИ У ПОЛЬЗОВАТЕЛЯ О ТЕХ МЕСТАХ ГДЕ ЕСТЬ СХОЖИЕ ВЕЩИ, ПОСЛЕ ЭТОГО ПОСТАРАЙСЯ ПОВТОРИТЬ РЕАЛИЗАЦИЮ!**

- **Шаг 1.** Найди в проекте схожий уже реализованный механизм.
- **Шаг 2.** Спроси у пользователя, где именно есть похожие вещи — он знает кодовую базу лучше.
- **Шаг 3.** Повтори существующую реализацию, не изобретая новых паттернов.
