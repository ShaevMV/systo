...
<p id="sub"><strong style="    color: #86201c;
    ...
    margin-bottom: 20px;">БИЛЕТ НЕ ПОДЛЕЖИТ ПРОДАЖЕ!</strong><br>
    В случае выявления факта продажи проходки, весь проект будет исключён из состава участников фестиваля<br><br>
